...
Drag and drop `1_サービス退会.csv`, the data for creating a prediction model (training).<br/>
{{% desktop_only %}}
...
Please select one variable to predict. (For this tutorial, select the variable "Withdraw or not (Prediction target)".)
After selecting, click the [Create Prediction Model] button.<br/>
{{% /div_slide %}}
