...
Specify `1_機器の故障.csv`, the data for creating a prediction model (training).<br/>
{{% desktop_only %}}
...
Please select one variable to predict. After selecting (For this tutorial, select the item "State (target)"), click the [Create Model] button.<br/>
{{% /div_slide %}}
