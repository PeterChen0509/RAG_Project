...
We found that we can predict loan default with good accuracy from the number of stars at the prediction accuracy level!
{{% /div_slide %}}
...
Current Ratio is effective for predicting a default on a loan, and from the content on the right side, you can see that "low Current Ratio" aids in predicting loan default.
You can check if it matches your intuition.
You may also discover unexpected relationships (the nature of the business was more involved than expected).
Then click "Predict".
{{% /div_slide %}}
