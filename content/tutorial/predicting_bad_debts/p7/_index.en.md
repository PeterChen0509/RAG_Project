...
Specify `1_貸し倒れ.csv`, the data for creating a prediction model (training).<br/>
{{% desktop_only %}}
...
Please select one variable to predict. For this tutorial, select the variable "Loan Default (Prediction Target)".
