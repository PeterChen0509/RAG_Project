...
予測精度レベルの星の数から、良い精度で苦情ラベルを予測できる事がわかりました！
{{% /div_slide %}}

{{% div_slide "ステップ2" normal %}}
![](../img/t_slide12.png)

精度を選択すると、さらに詳細な評価を見ることができます。
...
寄与度の詳細では、予測に対してどの入力項目がどう有効かを知ることができます。苦情タイプ予測では、
「投稿内容」がもっとも有効であることがわかります。

また、「投稿内容」にどういう単語が含まれると、「(a)外見」タイプと予測されやすいのかもわかります。
