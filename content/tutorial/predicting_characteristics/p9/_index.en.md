...
We found that we can predict the characteristic value with good accuracy from the number of stars at the prediction accuracy level!
{{% /div_slide %}}
...
You can see the contribution of each raw material to the prediction.
Looking further to the right, it is clear that the smaller the quantity of fragrance material 4, the higher the characteristic value is predicted.
