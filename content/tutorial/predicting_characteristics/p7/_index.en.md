...
Specify `1_製品特性.csv`, the data for creating a prediction model (training).<br/>
{{% desktop_only %}}
...
Please select one variable to predict. After selecting (for this tutorial, select the item "Characteristic Value (target)"), click the [Create Model] button.<br/>
{{% /div_slide %}}
