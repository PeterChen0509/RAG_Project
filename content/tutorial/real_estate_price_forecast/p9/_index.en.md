...
We found that we can predict the closing price with good accuracy from the number of stars at the prediction accuracy level!
{{% /div_slide %}}
...
In the closing price prediction, "Address", "Walk from the station", etc., are found to be important in the prediction.
