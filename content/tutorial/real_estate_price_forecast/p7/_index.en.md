...
Specify `1_成約価格.csv`, the data for creating a prediction model (training).<br/>
{{% desktop_only %}}
...
Please select one variable to predict. After selecting (For this tutorial, select the item "Closing Price (target)"), click the [Create Model] button.<br/>
{{% /div_slide %}}
