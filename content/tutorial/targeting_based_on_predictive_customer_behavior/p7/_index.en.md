...
Specify `1_プレミアムサービス購入.csv`, the data for creating a prediction model (training).<br/>
{{% desktop_only %}}
...
Please select one variable to predict. After selecting (for this tutorial, select the variable "Premium Service (target)"), click the [Create Model] button.<br/>
{{% /div_slide %}}
