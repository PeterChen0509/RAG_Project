...
予測精度レベルの星の数から、良い精度で入電数を予測できる事がわかりました！
{{% /div_slide %}}
...
寄与度では、予測に対してどの入力項目がどう有効かを知ることができます。
入電数予測では、「曜日」が重要で、さらに右側の内容から「土」「日」だと入電数を低めに予測し、「月」だと高めに予測することがわかります。

自分の直感と合っているか確認できます。他の項目の寄与度から新しい発見があるかもしれません。
