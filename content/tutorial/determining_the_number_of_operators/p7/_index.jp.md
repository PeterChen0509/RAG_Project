...
予測モデル作成(学習)用データである`1_入電数.csv`を指定してください。<br/>
{{% desktop_only %}}
...
予測したい項目を 1 つ選択してください。(このチュートリアルでは、「入電数(予測対象)」という項目を選択してください。選択後、「予測モデルを作成」ボタンをクリックしてください。<br/>
{{% /div_slide %}}

{{% div_slide "ステップ4" normal %}}
![](../img/t_slide24.png)

今回のチュートリアルでは時系列予測モードを使用しません。
このまま「予測モデルを作成」をクリックしてください。
{{% /div_slide %}}
