...
We found that we can predict the failure type with good accuracy from the number of stars at the prediction accuracy level!
{{% /div_slide %}}
...
This screen allows you to see which variables are effective for prediction and how they are effective. For failure type prediction, 
We can see that "Pointed Failure" is effective. The words that are important for prediction are also displayed on the right side.
