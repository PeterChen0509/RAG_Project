...
Specify `1_休暇取得.csv`, the data for creating a prediction model (training).<br/>
{{% desktop_only %}}
...
Please select one variable to predict. (For this tutorial, select the variable "Number of holidays (Prediction target)".)<br/>
After selecting, click the [Create prediction model] button.
{{% /div_slide %}}
